...
/**
 * @covers Propel\Generator\Util\DotGenerator::create
 */
class DotGeneratorTest extends \PHPUnit_Framework_TestCase
{
    public function testEmptyDatabase()
    {
        ...
        $this->assertEquals($expected, DotGenerator::create($db));
    }
