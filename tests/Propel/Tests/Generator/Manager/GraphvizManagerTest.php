...
/**
 * @covers Propel\Generator\Manager\GraphvizManager::createDotSyntax
 */
class GraphvizManagerTest extends \PHPUnit_Framework_TestCase
{
    public function testEmptyDatabase()
    {
        ...
        $this->assertEquals($expected, GraphvizManager::createDotSyntax($db));
    }
